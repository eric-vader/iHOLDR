# This file is used as a lib from https://github.com/treforevans/uci_datasets
# Some modifications made from original author code.
# Original Author: Trefor Evans
...
class Dataset:
    def __init__(self, base_path, dataset: str, dtype=np.float64, print_stats: bool = False):
        """
        load dataset
